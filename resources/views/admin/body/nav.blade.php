            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="{{ route('admin.dashboard') }}">
                        <img src="{{ asset('backend/assets/src/assets/img/logo2.svg')}}" class="navbar-logo" alt="logo">
                    </a>
                </li>
                    ...
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="avatar-container">
                            <div class="avatar avatar-sm avatar-indicators avatar-online">
                                <img alt="avatar" src="{{ asset('backend/assets/src/assets/img/profile-30.png')}}" class="rounded-circle">
                            </div>
                        </div>
                    </a>
                        ...
                        <div class="user-profile-section">
                            <div class="media mx-auto">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>{{ucfirst(Auth::user()->roles[0]->name)}}</p>
                                </div>
                            </div>
                        </div>
                        <div class="dropdown-item">
                            <a href="{{  route('edit.admin', Auth::user()->id) }}">
