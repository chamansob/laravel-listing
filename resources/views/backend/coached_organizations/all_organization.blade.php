                ...
                <div class="statbox widget box box-shadow">
                    <div class="widget-content widget-content-area">
                        <table id="html5-extension" class="table dt-table-hover">
                            ...
                            <tbody>
                                @foreach ($coached_organizations as $theme)
                                    <tr class="social-{{ $theme->id }}">

                                        <td>{{ $theme->id }}</td>
                                        <td>{{ !empty($theme->name) ? $theme->name : '-' }}</td>
                                        <td class="text-center">
                                            <button type="button" onClick="statusFunction({{ $theme->id }})"
                                        ...
                                        <td class="text-center">
                                            <div class="action-btns">
                                                ...
                                                <a href="{{ route('coached_organizations.edit', $theme->id) }}"
                                                    class="action-btn btn-edit bs-tooltip me-2" data-toggle="tooltip"
                                                    data-placement="top" title="Edit" data-bs-original-title="Edit">
                                                    <i data-feather="edit"></i>
                                                </a>

                                                <a href="#" onClick="deleteFunction({{ $theme->id }})"
